...
export const parseAssetStatus = (status: any): AssetStatus => {
  if (typeof status === 'number') return status;
  if (status?.pending !== undefined) return AssetStatus.Pending;
  if (status?.verified !== undefined) return AssetStatus.Verified;
  if (status?.tokenized !== undefined) return AssetStatus.Tokenized;
  if (status?.frozen !== undefined) return AssetStatus.Frozen;
  if (status?.delisted !== undefined) return AssetStatus.Delisted;
  return AssetStatus.Pending;
};

export const parseAssetType = (type: any): AssetType => {
  if (typeof type === 'number') return type;
  if (type?.realEstate !== undefined) return AssetType.RealEstate;
  if (type?.gold !== undefined) return AssetType.Gold;
  if (type?.infrastructure !== undefined) return AssetType.Infrastructure;
  if (type?.vehicle !== undefined) return AssetType.Vehicle;
  if (type?.art !== undefined) return AssetType.Art;
  if (type?.commodity !== undefined) return AssetType.Commodity;
  if (type?.other !== undefined) return AssetType.Other;
